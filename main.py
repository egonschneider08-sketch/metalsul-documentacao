    ...
    while True:
        ...
        if opcao == "1":
            ...
            try:
                ...
                unidade_medida = input("Unidade de Medida (ex: UN, KG) [Padrão UN]: ") or "UN"
            ...
            if produtos:
                for p in produtos:
                    ...
                    print(f"ID: {p_id} | Nome: {p.nome} | Preço Venda: R$ {p.preco_venda:.2f} | Est: {p.quantidade_estoque} | Status: {p.status}")
            else:
    ...
    while True:
        ...
        if opcao == "1":
            ...
            try:
                ...
                email = input("E-mail: ")
                senha = input("Senha: ")
                perfil = input("Perfil (ADMIN / OPERADOR) [Padrão OPERADOR]: ").upper() or "OPERADOR"
                ...
                print("Por favor, informe valores válidos para os campos.")
            ...
            if usuarios:
                for u in usuarios:
                    ...
                    print(f"ID: {u_id} | Nome: {u.nome} | E-mail: {u.email} | Perfil: {u.perfil} | Status: {u.status}")
            else:
